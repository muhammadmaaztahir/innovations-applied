...
const Home = () => {
  ...
  return (
    <>
        ...
        <Hero />
        <div className='flex px-10 flex-col sm:gap-14 gap-5 mt-10 container mx-auto'>
        ...
        <div className='bg-white w-full px-0 md:px-10'>
          <AppsDashboard />
        </div>
        <div className='container mx-auto sm:py-30 py-15 px-10'>
        ...
        <div className='sm:pt-20 pt-15 bg-white px-10 rounded-4xl'>
